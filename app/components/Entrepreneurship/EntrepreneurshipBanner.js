...
const Banner = () => {
  return (
    <>
      <div className="relative h-[110vh] md:h-[90vh]  md:w-full">
        <div className="absolute inset-0  bg-center bg-cover md:bg-[url('/entrepreneurship/entrepreneurship.png')] bg-[url('/entrepreneurship/Mobile-Banner.png')] "></div>
      </div>
    </>
  )
}
