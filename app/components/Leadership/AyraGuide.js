...
const AyraGuide = () => {
  return (
    <>
      <div className="md:py-10 py-0 px-4 md:px-3 container mx-auto space-y-6 ">
        <p className="text-base md:text-xl md:w-4/5 font-tthoves-light">
          ...
          entrepreneurship, and social innovation—but are united by a shared
        ...
        <p className="text-base md:text-xl md:w-4/5 font-tthoves-light">
          ...
          question them. And most importantly, they’re not afraid to reimagine
          what’s possible.
        </p>
      </div>
    </>
