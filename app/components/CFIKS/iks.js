...
const EmpoweringResearch = () => {
  const items = [
    "IKS at AYRA ensures every student graduates with both professional competence and cultural depth — equipped to think globally while rooted in the wisdom of their IKS-based heritage.",
  ...
  return (
    <>
      <div className="relative w-full h-[500px] md:h-[600px] container mx-auto mb-5 hidden md:block">
        ...
        {/* Overlay Content */}
        <div className="absolute bottom-64 left-4 right-4 md:right-4 md:left-auto flex justify-end items-center">
