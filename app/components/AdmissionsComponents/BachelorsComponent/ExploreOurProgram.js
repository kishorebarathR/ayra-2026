...
import { programs, bachelorsPrograms } from '../../../utils/AdmissionData/bachelorProgramData/bachelorProgramData';
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {programs.map((program, index) => (
            <div
              key={index}
              className="bg-[#FF5EBB] hover:bg-[#EC5A54] transition-colors duration-300 text-white p-6 shadow-md cursor-pointer"
            >
              <h3 className="text-xl font-bold mb-2 border-b border-dashed border-white pb-2 min-h-16">
                {program.title}
              </h3>
