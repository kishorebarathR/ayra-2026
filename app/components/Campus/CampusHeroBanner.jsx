...
const CampusHeroBanner = () => {
  return (
    <div className="h-[85vh] md:h-[90vh] bg-cover flex pb-5 md:pb-16 px-6 md:px-52 bg-[url('/campus/mob-banner.png')] md:bg-[url('/campus/campus-banner.png')]">
      <div className="flex items-end max-w-3xl">
        <p className="text-xs md:text-lg text-white md:px-16 font-tthoves-regular">
