...
const DesignedForCommunity = () => {
  return (
    <>
      {/* Large Screen Layout */}
      <div className="relative w-full h-[500px] md:h-[600px] lg:h-[700px] container mx-auto my-4 hidden lg:block">
        {/* Background Image */}
        <Image
          ...
          <div className="pl-6 md:pl-12 lg:pl-20 text-white max-w-[70%]">
            <ul className="mt-6 space-y-4 text-sm md:text-base font-tthoves-extralight">
              <li className="flex items-start gap-2">
                ...
                />
                <span>
                  Residential facilities that foster connections and
                  collaboration
                </span>
              </li>
              <li className="flex items-start gap-2">
      ...
      {/* Small Screen Layout */}
      <div className="my-10 bg-[url('/campus/design-banner-mob.png')] bg-cover bg-center h-screen flex items-end lg:hidden bg-[#002561]">
        <div className="flex items-center px-4 pb-24">
          <ul className="mt-6 space-y-4 text-sm text-white font-tthoves-extralight">
            <li className="flex items-start gap-2">
              <Image
                src="/rocket-icon.svg"
                width={20}
