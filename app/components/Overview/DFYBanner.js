    ...
    <>
      <div className="relative h-[100vh] md:h-[90vh] w-full ">
        <div className="absolute inset-0 bg-cover  md:bg-[url('/overview/distinct_banner.png')] bg-[url('/overview/Mobile-Banner.png')]">
          <div className="absolute top-[70%] md:top-[48%] px-3 md:px-0 my-14 md:my-0 md:left-[2%]">
            <p className="text-white text-xs md:text-base leading-relaxed md:max-w-md">
            ...
            <p className="text-white text-xs md:text-base leading-relaxed max-w-[380px] mt-5">
