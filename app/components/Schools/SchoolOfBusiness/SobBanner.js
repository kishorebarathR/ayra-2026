  ...
  return (
    <>
      <div className="relative h-[110vh] md:h-[90vh] w-full">
        <div className="absolute inset-0 bg-cover bg-center md:bg-[url('/schools/school-of-business/school-of-business.png')] bg-[url('/schools/hospitality/MobileBanner.png')] ">
